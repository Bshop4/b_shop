...
<html>
    ...
    <!--<div class="toTop">
      <span class="glyphicon glyphicon-open"></span>
    	...
    	<div class="btn-cart-lik"><a href="">＜返回购物车</a></div>
    	<div class="address-layout">
    		<div class="title">选择收获地址</div>
    		...
    		<div class="more-wrap">
    		  <span class="btn-no-data" style="font-size: 13px;">暂无收货地址　　</span>
			  <button type="submit" class="btn-address"><span class="btn-address-span">+使用新地址</span></button>
    		</div>
    		...
    		<div class="footer">
    			<div style="width: 1200px;height: 40px;">
    				<span>备注留言：</span><input style="height:36px;width: 600px;border: 1px solid dashed;padding-left: 10px;" placeholder="50字以内" maxlength="50" class="l_a_m ";>　</input>
    				<span class="sum-all" style="font-size: 20px; line-height: 40px;">应付金额：¥0.00</span>
    			</div>
