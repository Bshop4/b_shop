...
import bshow.web.servlet.form.DeleteBillByBillIdForm;
...
public class DeleteBillByBillIdAction extends Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response, ActionForm form)
		...
		DeleteBillByBillIdForm dbbf=(DeleteBillByBillIdForm)form;
		String bill_code = dbbf.getBillid();
		String account = dbbf.getAccount();
		Basedao bd = new Basedaoimpl();
		Bill_table bt1 = new Bill_table();
		bt1.setBill_code(bill_code);
//		System.out.println(bt);
		boolean f = bd.deleteObject("deleteBillById", bt1);
